...
namespace ExoticBackEnd
{
    public class Program
    {
        public static void Main(string[] args)
        {
                ...
                try
                {
                    ...
                    var vehicles = await query
                        .Select(v => new VehicleDto
                        {
                            ...
                            Year = v.Year,
                            Status = v.Status,
                            Times_Rented = (int)v.Times_Rented,
            ...
            app.MapPost("/api/auth/confirm", async (string token, ExoticDbContext db) =>
            {
            ...
            app.MapPost("/api/orders/verify", async (string token, ExoticDbContext db) =>
            {
                ...
                if (order.Vehicle != null)
                {
                    ...
                    order.Vehicle.Times_Rented = order.Vehicle.Times_Rented + 1;
                }
